#### 阿秀个人秋招总结文章：双非渣硕的秋招之路总结（已拿抖音研发岗SP)
...
<div align=center><figure class="one">
    <img src="https://cdn.jsdelivr.net/gh/forthespada/mediaImage2@1.2/202103/img1.png" style="right;zoom: 800%;" /                                                                                   </figure></div>
...
最终成功走到了**6**家公司的**offer**环节：**字节跳动研发岗SP、华为通用软件开发、百度C++研发岗、B站后端研发岗、深信服C++研发岗以及**农业银行研发岗**，最后签了**字节跳动，也是自己心心念念的大厂之一，十分满意了~
