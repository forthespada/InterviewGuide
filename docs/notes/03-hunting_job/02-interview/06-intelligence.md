...
**1、25匹马5条跑道找最快的3匹马，需要跑几次？** 
 ...
 ![](https://oss.interviewguide.cn/img/202205220037552.png)
...
![](https://oss.interviewguide.cn/img/202205220037654.png)

 第二步
 取每组第一名进行一次比赛，然后淘汰最后四名所在组的所有马，如下图（需要比赛1场） 

 ![](https://oss.interviewguide.cn/img/202205220037469.png) 

 这个时候总冠军已经诞生，它就是A1，蓝域（它不需要比赛了）。

而其他可能跑得最快的三匹马只可能是下图中的黄域了（A2,A3,A4,B1,B2,B3,C1,C2,D1，共9匹马） 

 ![](https://oss.interviewguide.cn/img/202205220037703.png) 
