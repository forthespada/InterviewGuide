        ...
        <div class="toc-container">
            <div class="pos-box">
              ...
              <div class="scroll-box" style="text-align:center" >
                ...
                <img v-bind="{src: 'https://api.qrserver.com/v1/create-qr-code/?data=https://interviewguide.cn'+this.$route.fullPath }" height="180px" style="margin:10px;"/>
...
<!--      todo 知识星球文案-->
      ...
      <div class="option-box" v-on:mouseover="showToc($event)" v-on:mouseout="hideToc($event)">
        ...
        <span class="show-txt">卷王群</span>
        <div class="toc-container">
            <div class="pos-box">
              <div class="icon-arrow"></div>
              <div class="scroll-box" style="text-align:center" >
                <span style="font-size:0.8rem;font-weight:bold;">添加阿秀微信<span style="color:red;">(coderxiu2)</span>进校招/社招群学习，谢绝任何广告党！</span>
                <img src="/images/personal/coderxiu2.png" height="180px" style="margin:10px;"/>
                PS：添加时校招党请备注<b>校招</b>，社招党备注<b>社招</b>，谢谢！
              </div>
            </div>
        </div>
      </div>
      ...
      <div class="option-box" v-on:mouseover="showToc($event)" v-on:mouseout="hideToc($event)">
        <img class="nozoom" src="/images/system/download.png" width="25px" />
        <span class="show-txt">资料</span>
        <div class="toc-container">
            <div class="pos-box">
              <div class="icon-arrow"></div>
              <div class="scroll-box" style="text-align:center" >
                <span style="font-size:0.7rem;font-weight:bold;">阿秀自己的公众号，回复<span style="color:red;">“宝贝”</span>下载<span style="color:red;">100GB+</span>大学到毕业分阶段学习技术资料、经典PDF书籍、简历模板、社招校招资料等「无任何套路」</span>
                <img src="/images/personal/coderAxiu-avatar.png" height="180px" style="margin:10px;"/>
                <b>公众号:</b> 拓跋阿秀
              </div>
            </div>
        </div>
      ...
      <div class="option-box" v-on:mouseover="showToc($event)" v-on:mouseout="hideToc($event)">
        <img class="nozoom" src="/images/system/red-heart.png" width="25px" />
        <span class="show-txt">支持我</span>
        <div class="toc-container">
            <div class="pos-box">
              <div class="icon-arrow"></div>
              <div class="scroll-box" style="text-align:center" >
                <span style="font-size:0.8rem;font-weight:bold;">鼓励/支持/赞赏阿秀</span>
                <img height="180px" src="/images/personal/wechat-sponer.png" style="margin:5px;"/>
                <br>1. 如果我的总结帮助到你了，不妨请我喝杯咖啡；
                <br>2. 持续学习是一个技术人为数不多能够保持核心竞争力的方法，一起进步；
              </div>
            </div>
        </div>
      </div>
